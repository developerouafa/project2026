...
class RolesUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Dashboard_UMC.roles.index',compact('roles'))->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function create()
    {
        ...
        return view('Dashboard_UMC.roles.create',compact('permission'));
    }
    ...
    public function show($id)
    {
        ...
        ->get();
        return view('Dashboard_UMC.roles.show',compact('role','rolePermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        ->all();
        return view('Dashboard_UMC.roles.edit',compact('role','permission','rolePermissions'));
    }
