					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
                                    <?php
                                        use App\Models\User;
                                        $imageuser = User::query()->where('id', '=', Auth::user()->id)->first();
                                    ?>
                                        @if (empty($imageuser->image))
                                            <a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/6.jpg')}}"></a>
                                        @else
                                            <a class="profile-user d-flex" href=""><img src="{{URL::asset('storage/'.$imageuser->image)}}"></a>
                                        @endif
                                        <div class="dropdown-menu">
                                            <div class="main-header-profile bg-primary p-3">
                                                <div class="d-flex wd-100p">
                                                    ...
                                                    @else
                                                        <div class="main-img-user"><img alt="" src="{{URL::asset('storage/'.$imageuser->image)}}" class=""></div>
                                                    @endif
