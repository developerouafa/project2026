            ...
            <div class="mb-4 main-content-label">{{__('Dashboard/profile.personalinformation')}}</div>
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" required="" class="form-control" value="{{Auth::guard('clients')->user()->name}}"  autofocus autocomplete="name" >
                ...
                <div class="form-group ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="phone" class="form-control" value="{{Auth::guard('clients')->user()->phone}}" autofocus autocomplete="phone" >
