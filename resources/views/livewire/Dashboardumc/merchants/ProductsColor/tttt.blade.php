                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <button type="button"
                                ...
                                wire:click="toggleVariant(false)">
                            No
                        </button>

                        <button type="button"
                                class="btn btn-sm {{ $has_variants ? 'btn-primary' : 'btn-outline-secondary' }}"
                                wire:click="toggleVariant(true)">
                            Yes
                        </button>
                    </div>
                    ...
                    @foreach($colors_with_sizes as $color_index => $color)
                        <div class="border p-3 mb-3">
                            ...
                            <div class="d-flex gap-2 mb-2">
                                ...
                                <button type="button"
                                    class="btn btn-danger btn-sm"
                                    wire:click="removeColor({{ $color_index }})">
                                    X
                                </button>
                            </div>
                            ...
                            @foreach($color['sizes'] ?? [] as $size_index => $size)
                                <div class="d-flex gap-2 mb-2">
                                    ...
                                    <button type="button"
                                        class="btn btn-danger btn-sm"
                                        wire:click="removeSize({{ $color_index }}, {{ $size_index }})">
                                        X
                                    </button>
                                </div>
                            @endforeach
                            ...
                            <button type="button"
                                ...
                                wire:click="addSize({{ $color_index }})">
                                Add Size
                            </button>
                        </div>
                    @endforeach
